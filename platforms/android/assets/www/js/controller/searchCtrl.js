userpaApp.controller('searchCtrl', ['$scope', 'sqliteFactory', 'imagesFactory', '$rootScope', '$ionicLoading', 'providerFactory', 'providerDetailFactory','$state', function ($scope, sqliteFactory, imagesFactory, $rootScope, $ionicLoading, providerFactory ,providerDetailFactory,$state) {
    ...
    {
      $scope.providers = providerFactory.providerList;
    }
